...
exports.validateAddQuantity = exports.validateAddItem = void 0;
const joi_1 = __importDefault(require("joi"));
const addItemSchema = joi_1.default.object({
    quantity: joi_1.default.number().required(),
    expiry: joi_1.default.number().required(),
});
const addQuantitySchema = joi_1.default.object({
    quantity: joi_1.default.number().required(),
});
...
const validateAddQuantity = (req, res, next) => {
...
exports.validateAddQuantity = validateAddQuantity;
